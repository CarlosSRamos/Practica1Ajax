...
public class Login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response,Usuario usuario)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 class=\"titulo\">Perfil de: "+ usuario.getNombre() +"</h1>");
            out.println("Nombre: " + usuario.getNombre() + "<br>");
            out.println("Contraseña: " + usuario.getContraseña() + "<br>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Usuario usuario = new Usuario(request.getParameter("nombrePost"),request.getParameter("contrasenaPost"));
        processRequest(request, response, usuario);
    }
